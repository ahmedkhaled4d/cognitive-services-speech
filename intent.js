...
(function () {
  ...
  module.exports = {
    main: function (settings) {
      ...
      var intentConfig = sdk.SpeechConfig.fromSubscription(
        settings.luSubscriptionKey,
        settings.luServiceRegion
      );
      ...
      if (
        settings.luAppId !== "" &&
        settings.luAppId !== "YourLanguageUnderstandingAppId"
      ) {
      ...
      recognizer.recognized = function (s, e) {
        ...
        switch (e.result.reason) {
          ...
          case sdk.ResultReason.RecognizedIntent:
            str +=
              " Text: " + e.result.text + " IntentId: " + e.result.intentId;
            ...
            str +=
              ...
              e.result.properties.getProperty(
                sdk.PropertyId.LanguageUnderstandingServiceResponse_JsonResult
              );
            break;
